...
# Second plot
ax1.plot(tvalues,list(y[0] for y in yvalues), label = "position") # plot y[0]
ax2.plot(tvalues,list(y[1] for y in yvalues), label = "velocity") # plot y[1]

yvalues = np.transpose(yvalues)
ax3.plot(yvalues[0], yvalues[1])
...
ax3.set_title('Phase plot: Velocity vs position')
